...
Function Get-UALData {
    ...
    Connect-ExchangeOnline -UserPrincipalName avrublevsky@linquest.com -ShowProgress $true -ConnectionUri https://outlook.office365.us/powershell-liveid -AzureADAuthorizationEndPointUri https://login.microsoftonline.us/common $ExchangeEnvironment
...
Function Get-AzureDomains{
    ...
    #Connect to AzureAD
    Connect-AzureAD -AzureEnvironmentName AzureUSGovernment $AzureEnvironment
